...
cd /tmp
cp -r $GOPATH/src/github.com/nuagenetworks/nuage-cni nuage-cni-mesos-${version}
...
rpmbuild -ba $GOPATH/src/github.com/nuagenetworks/nuage-cni/rpmbuild/nuage-cni-mesos.spec
